...
connectionStateString.innerHTML = "<span style='color:white;'>Waiting for Websocket connection...</span>";
...
const onOpen = () => {
    ...
    connectionStateString.innerHTML = "<span style='color:green;'>Websocket is open now</span>";
};

const onError = (event) =>{
    console.log(`websocket throw error: ${event}`);
    connectionStateString.innerHTML = "<span style='color:red;'>failed to open websocket</span>";
};
